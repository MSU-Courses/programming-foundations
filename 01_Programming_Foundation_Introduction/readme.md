...
- [История программирования. Что такое программирование?](#история-программирования-что-такое-программирование)
  ...
  - [Немного про историю вычислительных устройств](#немного-про-историю-вычислительных-устройств)
...
**Алгоритм (algorithm)** - конечная последовательность однозначных действий, предназначенная для решения определённого класса задач.

- _Конечная_ - потому что процесс должен завершаться.
- _Однозначных_ - потому что на каждом шаге должно быть понятно, что делать, без вариантов толкования.
- _Класса задач_ - потому что хороший алгоритм решает не один конкретный пример, а любую задачу подходящего вида: не "сколько будет 12 плюс 7", а "как сложить два любых целых числа".
...
## Немного про историю вычислительных устройств
