...
Рассотрим _алгоритм с ветвлением_, который выбирает, что делать в зависимости от условия.
...
3. Алгоритм обладает свойствами дискретности, определённости, конечности, результативности и массовости.
