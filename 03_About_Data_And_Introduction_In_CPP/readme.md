...
![Рисунок 3.1. Символ превращается в номер по кодировке, а номер хранится в памяти как набор битов](../_images/03/fig-char-code.svg)

_Рисунок 3.1. Представление символа в памяти_

Таблица ASCII показывает соответствие символов и их числовых кодов:

![Рисунок 3.2. Таблица кодов ASCII: печатные символы и соответствующие им числа](../_images/03/ascii-table.webp)

_Рисунок 3.2. Таблица кодов ASCII_
...
![Рисунок 3.3. Разбор минимальной программы: строка include, главная часть main, вывод и return](../_images/03/scheme-3.1-program-structure.svg)

_Рисунок 3.3. Из чего состоит минимальная программа_
...
![Рисунок 3.4. Разбор строки: тип int, имя health, знак присваивания, литерал 100 и точка с запятой](../_images/03/scheme-3.2-declaration-parts.svg)

_Рисунок 3.4. Части объявления с начальным значением_
